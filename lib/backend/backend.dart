...
import 'schema/appoinmen_record.dart';
...
export 'schema/appoinmen_record.dart';
...
/// Functions to query AppoinmenRecords (as a Stream and as a Future).
Future<int> queryAppoinmenRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AppoinmenRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AppoinmenRecord>> queryAppoinmenRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AppoinmenRecord.collection,
      AppoinmenRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AppoinmenRecord>> queryAppoinmenRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
